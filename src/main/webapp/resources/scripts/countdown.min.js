    ...
    var b = function(b, c) {
        ...
        e = function(a, b) {
            ...
            var d = '<div class="years"><span class="count">' + a.years + '</span><span class="title">Years</span></div>',
                e = '<div class="days"><span class="count">' + a.days + '</span><span class="title">روز </span></div>',
                f = '<div class="seconds"><span class="count">' + a.seconds + '</span><span class="title">ثانیه </span></div>',
                g = '<div class="minutes"><span class="count">' + a.minutes + '</span><span class="title">دقیقه </span></div>',
                h = '<div class="hours"><span class="count">' + a.hours + '</span><span class="title">ساعت </span></div>',
                i = !1,
                j = !1,
                k = !1,
                l = !1,
