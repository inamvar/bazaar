					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								...
								<form:select class="form-control input-sm" path="category.id"
						...
						<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<form:select class="form-control input-sm" path="merchant.id"
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<c:forEach items="${deal.options}" varStatus="loop">
									...
									<!-- Generate the fields -->
									<form:input path="options[${loop.index}].id" hidden="true" />
									<div class="col-sm-4">
										<div class="form-group">
											<form:input class="form-control input-sm" path="options[${loop.index}].name" />
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<form:input class="form-control input-sm" path="options[${loop.index}].description" />
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											<form:input class="form-control input-sm" path="options[${loop.index}].discount" />
										</div>
									</div>
									<!-- Add the remove flag -->
									<div class="col-sm-1">
									...
									<c:forEach items="${deal.images}" varStatus="image" var="imageObj">
										<tr>
											<td><form:hidden path="images[${image.index}].name"></form:hidden>
												...
												<img src="${pageContext.request.contextPath}/files/attachments/<c:out value="${imageObj.id}"/>/dynamicImage?width=250&height=150" width="250" height="150" class="img img-rounded"/>
