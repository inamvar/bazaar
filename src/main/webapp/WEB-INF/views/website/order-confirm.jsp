		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-sm-12">
						<c:if test="${ not empty orders.coupons}">
							...
							<table>
								...
								<tbody>
									<c:forEach items="orders.coupons" var="coupon">
										<tr>
											<td>${coupon.code}</td>
											<td><img
												src="${pageContext.request.contextPath}/files/coupons/${coupon.id}/barcode" /></td>
											<td><img
												src="${pageContext.request.contextPath}/files/coupons/${coupon.id}/qrcode" /></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
						</c:if>
						<c:if test="${empty orders.coupons}">
