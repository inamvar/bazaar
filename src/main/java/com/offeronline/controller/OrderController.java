...
/*	private static final Logger logger = LoggerFactory
	...
	public String list(
		...
		uiModel.addAttribute("statusValues", OrderStatus.values());
...
/*		else {
	...
	public String list(@RequestParam(required = false, value="startDate") String startDateString,
		...
		List<Order> orders = orderService.findOrders(startDate, endDate, customerFirstName, customerLastName, merchantName, dealName,status, orderId ==null ? 0 : orderId);
