package com.offeronline.aspect;
...
public class NotificationAspect {
	...
	@Around("within(com.offeronline.service.CRUDService+) && target(com.offeronline.service.merchant.MerchantServiceImp) && execution(* create(..))")
	...
	@Around("within(com.offeronline.service.CRUDService+) && target(com.offeronline.service.person.PersonServiceImp) && execution(* create(..))")
	...
	@Around("within(com.offeronline.service.CRUDService+) && target(com.offeronline.service.CustomerServiceImp) && execution(* create(..))")
	...
	@Before("within(com.offeronline.service.CRUDService+) && target(com.offeronline.service.order.OrderServiceImp) && execution(* create(..))")
	...
	@AfterReturning(pointcut = "within(com.offeronline.service.CRUDService+) && target(com.offeronline.service.order.OrderServiceImp) && execution(* create(..))", returning = "order")
...
/*		Journal journal = new Journal();
	...
	@Around("within(com.offeronline.service.CRUDService+) && target(com.offeronline.service.person.PersonServiceImp) && execution(* changePassword(..))")
	...
	@Around("within(com.offeronline.service.CRUDService+) && target(com.offeronline.service.person.PersonServiceImp) && execution(* resetPassword(..))")
